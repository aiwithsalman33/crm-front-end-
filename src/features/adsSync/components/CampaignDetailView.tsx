...
import type { MetaAdSet, MetaAd } from '../../../contexts/MetaAccountContext';
      ...
      <div className="border-b border-gray-200">
        <nav className="-mb-px flex space-x-8">
          <button
            ...
            className={`py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'adsets'
          ...
          <button
            ...
            className={`py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'ads'
                ? 'border-primary text-primary'
                : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
              }`}
          >
